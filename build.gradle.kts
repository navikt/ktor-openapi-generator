...
dependencies {
    ...
    implementation("com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.18.1") // needed for multipart parsing
    ...
    testImplementation("ch.qos.logback:logback-classic:1.5.12") // logging framework for the tests

    testImplementation("org.junit.jupiter:junit-jupiter-api:5.11.1") // junit testing framework
    testImplementation("org.junit.jupiter:junit-jupiter-params:5.11.3") // generated parameters for tests
    testRuntimeOnly("org.junit.jupiter:junit-jupiter-engine:5.11.2") // testing runtime
}
