...
dependencies {
    ...
    implementation("com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.20.0") // needed for multipart parsing
    ...
    testImplementation("ch.qos.logback:logback-classic:1.5.19") // logging framework for the tests
